...
********************************************************************************
*************		REPLICANDO INDICADORES INE 2019                *************
********************************************************************************

use "D:\Encuestas Hogares\Encuesta de Hogares 2019\EH2019_Persona.dta"
global year 2019
...
*** Asalariado
 ...
 gen     salaried=0
 replace salaried=1   if emppri==1 & (s06b_14==1 | s06b_14==2  | s06b_14==8)
 **recode** **************************************************************
...
recode  s06c_25a *=. if s06c_25a>=880000							// Q. cuanto es su salario liquido
...
replace yprijb=yind1fin					if s06b_14==3 | s06b_14==4 | s06b_14==5
replace yprijb=0						if s06b_14==6
...
*ASALARIADO
* Ingreso liquido en horario normal
fincome s06f_42b, by(s06e_39)						
recode  s06f_42a *=. if s06f_42a>=880000
capture drop ysal2net
gen ysal2net=.
replace ysal2net=s06f_42a*freq
...
recode s06f_43b1 *=. if s06f_43b1>=880000
gen ysal2esp_a=s06f_43b1/12

*2. Vivienda/Otros
recode s06f_43c1 *=. if s06f_43c1>=880000
gen ysal2esp_b=s06f_43c1/12
...
*Ingreso Total
fincome s06f_44b, by(s06e_39)
recode s06f_44a *=. if s06f_44a>=880000
capture drop yind2tot
gen yind2tot=.
replace  yind2tot=s06f_44a*freq

*Ingreso Neto
fincome s06f_46b, by(s06e_39)
recode s06f_46a *=. if s06f_46a>=880000
capture drop yind2net
gen yind2net=s06f_46a*freq
...
replace ysecjb=yindfin			if s06e_36==3 | s06e_36==4 | s06e_36==5
replace ysecjb=0				if s06e_36==6
