...
********************************************************************************
*************		REPLICANDO INDICADORES INE 2011                *************
********************************************************************************

use "D:\Encuestas Hogares\Encuesta de Hogares 2011\eh_2011_persona.dta"
global year 2011
...
gen spbja =  (s3_22 == 1) if s3_22  != .

capture drop spbja_monto
gen spbja_monto = s3_22a /* En los 12 meses, cu�nto dinero ha cobrado �por los controles real */

capture drop spbja_b /*BJA: controles bimestrales */
gen spbja_b = (s3_22b > 0 ) if s3_22b !=.

capture drop spbja_bmonto
gen spbja_bmonto = s3_22b      /* 125 bs por cada control post parto */
...
recode  s5_48a *=. if s5_48a>=880000
...
replace s6_09a=s6_09a*freq*tc6 if  s6_09b=="G" & s6_09e=="SOLES"	//soles
replace s6_09a=s6_09a*freq*tc7 if  s6_09b=="G" & s6_09e=="BOLIVARES"	//Bolívares
