...
********************************************************************************
*************		REPLICANDO INDICADORES INE 2014                *************
********************************************************************************

use "D:\Encuestas Hogares\Encuesta de Hogares 2014\eh_2014_persona.dta"
global year 2014
...
capture drop id_hh
gen id_hh = year+ _count+ "0" +string(idep)+ string(estrato)
...
recode  s6c_25a *=. if s6c_25a>=880000
...
recode s6c_26a *=. if s6c_26a>=880000
capture drop ysal1ben_1
gen ysal1ben_1=s6c_26a/12

*2. Aguinaldo mensualizado
recode s6c_26b *=. if s6c_26b>=880000
capture drop ysal1ben_2
gen ysal1ben_2=s6c_26b/12

*3. Comisiones
fincome s6c_27a_2, by(s6b_22)	
recode s6c_27a_1 *=. if s6c_27a_1>=880000
capture drop ysal1ben_3
gen ysal1ben_3=.
replace ysal1ben_3=s6c_27a_1*freq  

*4. Horas Extra
fincome s6c_27b_2, by(s6b_22)
recode s6c_27b_1 *=. if s6c_27b_1>=880000
capture drop ysal1ben_4
gen ysal1ben_4=.
replace ysal1ben_4=s6c_27b_1*freq
...
gen ysal1ben_5=(salmin*s6c_28a_2)/12 if s6c_28a_1==1
...
*1. Alimentos
fincome s6c_30a_2, by(s6b_22)									
recode s6c_30a_3 *=. if s6c_30a_3>=880000 
gen  ysal1esp_1=s6c_30a_3*freq

*2. Transporte
fincome s6c_30b_2, by(s6b_22)
recode s6c_30b_3 *=. if s6c_30b_3>=880000
gen ysal1esp_2=s6c_30b_3*freq

*3. Vestidos y Calzado
fincome s6c_30c_2, by(s6b_22)
recode s6c_30c_3 *=. if s6c_30c_3>=880000
gen ysal1esp_3=s6c_30c_3*freq

*4. Vivienda
fincome s6c_30d_2, by(s6b_22)
recode s6c_30d_3 *=. if s6c_30d_3>=880000
gen ysal1esp_4=s6c_30d_3*freq

*5. Otros
fincome s6c_30e_2, by(s6b_22)
recode s6c_30e_3 *=. if s6c_30e_3>=880000
gen ysal1esp_5=s6c_30e_3*freq
...
recode  s6f_41a *=. if s6f_41a>=880000
...
recode s6f_42b_2 *=. if s6f_42b_2>=880000
gen ysal2esp_a=s6f_42b_2/12

*2. Vivienda/Otros
recode s6f_42c_2 *=. if s6f_42c_2>=880000
gen ysal2esp_b=s6f_42c_2/12
...
for varlist s7a_01a s7a_01b s7a_01c s7a_01d s7a_01e_a: recode X *=. if X>=880000    /*jubila, etc*/	
for varlist s7a_02a s7a_02b s7a_02c_1: 	recode X *=. if X>=880000            /*rentas*/		
for varlist s7a_03a s7a_03b s7a_03c: recode X *=. if X>=880000            /*renta capi*/ 	
for varlist s7a_04a s7a_04b s7a_04c: recode X *=. if X>=880000            /*ing.extraor*/ 
for varlist s7b_05a_1 s7b_05b_1 :	recode X *=. if X>=880000            /*tranf.o.h*/	
for varlist s7c_08a: recode X *=. if X>=880000 	//	             /*remesas*/
                                                          				
*** Annualizing and converting to Bs.                                               				
for varlist s7a_03a s7a_03b s7a_03c: 		replace X =X/12       	
for varlist s7a_04a s7a_04b s7a_04c:	 	replace X =X/12

capture drop aux*
fincome s7b_05a_2
gen aux33=s7b_05a_1*freq

fincome s7b_05b_2
gen aux55=s7b_05b_1*freq
...
replace aux77=s7c_08a*freq*tc6 if  s7c_08b=="G" & s7c_08c=="sOLES"	//soles
replace aux77=s7c_08a*freq*tc7 if  s7c_08b=="G" & s7c_08c=="bOLIVARES"	//bolívares
replace aux77=s7c_08a*freq*tc8 if  s7c_08b=="G" & s7c_08c=="LIBRAS ESTERLINAS"	//bolívares
				
* Income from social security *
note: sin renta dignidad
capture drop ysstot
egen ysstot=rsum(s7a_01a s7a_01b s7a_01c s7a_01d),m

* Income from property *
capture drop yprotot
egen yprotot=rsum(s7a_02a s7a_02b s7a_02c_1 s7a_03a s7a_03b s7a_03c),m
...
egen ytrgtot=rsum(s7a_01e_b),m // only renta dignidad in this case

* Other non labor income *
capture drop yothtot
egen yothtot=rsum(s7a_04a s7a_04b s7a_04c) ,m					//UDAPE no lo toma en cuenta 
